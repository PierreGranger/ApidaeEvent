<?php
	...
	*	@param selection_territoires 	int 	Identifiant de la sélection qui contient toutes les fiches territoires des offices concernés (optionnel)
	...
	*	@param communes_insee string  Liste de codes insee des communes à proposer dans le formulaire (à défaut de territoire)
	...
	**/
	...
	$configApidaeEvent = Array(
		...
		'mail_admin' => 'pierre.granger@apidae-tourisme.com',
		'recaptcha_secret' => '',
		'recaptcha_sitekey' => '',
		'http_path' => '',
